...
luodaan uusi käyttäjä kantaan joka pääsee samantien muokkamaan kantaa
 ja authenticateUser
jolla suoritetaan autentikaatio eli lähetetään tunnarit ja verrataan niitä kannassa
oleviiin ja jos on samat niin päästetään tekemään kannan muokkausta.
*/
